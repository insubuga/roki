  ...
  return (
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="flex items-center gap-3">
        <Button variant="ghost" size="icon" onClick={() => navigate('/Configuration')} aria-label="Back to Configuration" className="text-muted-foreground hover:text-foreground flex-shrink-0">
